...
function HeaderSearchnavbar() {
    ...
    return (
        <div
            ...
            // className="border-grey-07 bg-grey-03 text-grey-06 relative my-1 mr-auto grow rounded-lg border py-1 pb-2 text-center text-sm sm:w-[21rem] sm:grow-0 md:w-[28rem] lg:w-[30rem]"
            className="border-grey-07 bg-grey-03 text-grey-06 relative my-1 mr-auto grow rounded-lg border py-0.5 pb-1 text-center text-sm sm:w-[21rem] sm:grow-0 md:w-[28rem] lg:w-[30rem]"
        >
