...
function NavPages({
    ...
    const searchMenuStyles = `bg-black-02 z-50 flex flex-col gap-2 rounded-md  p-1
    `
    ...
    return (
        <nav
            id="main-nav"
            className={`pb-[3px] text-grey-01${stylesNavMobile ? navStylesSidebar : ''} ${stylesSearchMenu ? searchMenuStyles : ''}`}
        >
